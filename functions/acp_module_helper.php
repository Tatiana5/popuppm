 ...
 *
 * @package       Popup PM
 * @copyright (c) 2014 - 2016 Татьяна5 and LavIgor
 * @license       http://opensource.org/licenses/gpl-license.php GNU Public License
 *
 */

namespace tatiana5\popuppm\functions;
...
abstract class acp_module_helper
{
	...
	protected function output_basic_vars()
	{
		$this->template->assign_vars(array(
			...
			'L_TITLE_EXPLAIN' => isset($this->user->lang[$this->display_vars['title'] . '_EXPLAIN']) ? $this->user->lang[$this->display_vars['title'] . '_EXPLAIN'] : '',
